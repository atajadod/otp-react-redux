...
function createOtpReducer (config, initialQuery) {
  ...
  return (state = initialState, action) => {
    ...
    switch (action.type) {
      ...
      case 'AGENCIES_RESPONSE':       
      //console.log("AGENCIES_RESPONSE",action.payload);
      //console.log("--------------------------------AGENCIES_RESPONSE",action.payload);
        return update(state, {
          $merge:{
      ...
      case 'AGENCY_BY_FEEDID_RESPONSE':       
      //console.log("--------------------------------AGENCY_BY_FEEDID_RESPONSE",action.payload);
        return update(state, {
          $merge:{
            agencies: action.payload,
          }
        ...
        //   overlay: {
        //     transit: {
        //       agencies: { $set: {agencies:action.payload.agency, feedId: action.payload.feedId}},
        //       pending: { $set: false }
        //     }
        //   }
        // })  
      case 'CLEAR_AGENCY_BY_FEEDID_RESPONSE':
        return update(state, {
          overlay: {
            transit: {
              agencies: { $set: [] },
