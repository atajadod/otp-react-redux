...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    maxNumberOfIterations: state.otp && state.otp.config.plan && state.otp.config.plan.maxNumberOfIterations ,
    preferredAgency: state.otp && state.otp.config.plan && state.otp.config.plan.preferredAgency,
    preferredAgencyCount: state.otp && state.otp.config.plan && state.otp.config.plan.preferredAgencyCount
  }
}
