...
class StopsOverlay extends MapLayer {
  ...
  render () {
    const { leaflet, minZoom, setLocation, setViewedStop, setMainPanelContent, stops, languageConfig, icons } = this.props
...
class StopMarker extends Component {
  ...
  render () {
    ...
    //const icon=l.icon({iconUrl:ba, iconSize:L.point(30,30)})
