...
/**
 * @param  {string}  actmode true/false/1/0
 * @return {boolean} whether if is optimized for actransit
 */
export function isActMode (actmode) {
  return (actmode && (actmode==1 || actmode=='1' || actmode=='true'));
}
